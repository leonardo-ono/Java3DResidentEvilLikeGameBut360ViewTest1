...
public class World {
    ...
    public static void drawBody(Graphics2D g, Body body) {
        ...
        g.drawString(body.getId() + "(" + ((int) body.x) + "," 
                + ((int) body.y) + ") h:" + ((int) body.height)
    ...
    public void teleport(
            Body body, String triangleId, double x, double y) {
