...
img, zbuf = readEXR("D:/models/abandoned_alysium/alysium.exr")
print(zbuf[400][400])
#np.savetxt('d:/zbuf_exp.txt', zbuf)

a = array(zbuf,'float32')
output_file = open('D:/models/abandoned_alysium/alysium.dat', 'wb')
