...
public class BackgroundRenderer implements MouseMotionListener {
    ...
    private static final double ACCURACY_FACTOR = 512 * 1; 
    ...
    public BackgroundRenderer(int width, int height) {
        ...
        try {
            BufferedImage sphereTmpImage = ImageIO.read(getClass().getResourceAsStream("/res/office.png"));
    ...
    private void loadBackgroundDepthBuffer(int width, int height) {
        try {
            ...
            BufferedImage depthTmp = ImageIO.read(getClass().getResourceAsStream("/res/office_depth.png"));
