...
//    }
    ...
    public void retrieveCollidingWalls(Player player, List<Wall> collidingWalls) {
        retrieveCollidingWallsInternal(currentVisitedId++, player, collidingWalls);
    }
    
    private void retrieveCollidingWallsInternal(int visitedId, Player player, List<Wall> collidingWalls) {
    ...
    public Triangle getCurrentTriangle(Player player) {
        return getCurrentTriangleInternal(null, this, player);
    }
    
    public Triangle getCurrentTriangleInternal(Triangle previous, Triangle current, Player player) {
    ...
    public void drawRecursive(Graphics2D g, Player player, int width, int height) {
    ...
    private void drawRecursiveInternal(int visitedId, Graphics2D g, Player player) {
        if (this.visitedId == visitedId) return;
        this.visitedId = visitedId;
