...
//        } catch (InterruptedException ex) { }
    ...
    public void update() {
        ...
        Triangle currentTriangle = world.getCurrentTriangle();
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            frame.setTitle("'Resident Evil 1'-like game but 360 view test #3 - physics & multiple cameras");
